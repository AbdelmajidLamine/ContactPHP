...
<?php
    ...
    $connect = new PDO($dburl, $user,$pass, $pdo_options);
     ...
     $IDC=$_GET['id'];
   	    ...
   	    $donnee=$connect->prepare('DELETE FROM addgroupe WHERE id_contact=:IDC AND id_group=:IDG');
   	    $donnee->execute(array('IDC'=>$IDC,'IDG'=>$IDG));
   	    echo "le groupe a ete bien Supprimer";
